...
| 004 | `specs/004-merchant-update-delete-offers-endpoints/` | Step 6.4 — Merchant: update & delete offers | ✅ Complete |
| 005 | `specs/005-merchant-incoming-orders-endpoint/` | Step 6.5 — Merchant: view incoming orders | ✅ Complete |
