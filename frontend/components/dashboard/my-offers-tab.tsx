...
export function MyOffersTab({ onNavigateToAddOffer }: MyOffersTabProps) {
  ...
  if (isLoading) {
    return (
      <div className="space-y-4 animate-pulse" data-testid="offers-loading">
      ...
      >
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1 max-w-md mx-auto">
            You haven&apos;t added any product listings to your inventory yet. Search
            the catalog or create a new product to start selling.
          </p>
        </div>
  ...
  return (
    <div className="space-y-6" data-testid="offers-container">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Manage your pricing, inventory stock, and delivery times ({offers.length}{" "}
      ...
      <div className="overflow-x-auto rounded-xl border border-border bg-card">
        <table className="w-full text-left border-collapse" data-testid="offers-table">
          <thead>
